...
tombolBaru.addEventListener('click', function () {
    const r = Math.round(Math.random() * 255 + 1); //math.round pembulatan keatas
    const g = Math.round(Math.random() * 255 + 1); //math.round pembulatan keatas
    const b = Math.round(Math.random() * 255 + 1); //math.round pembulatan keatas
    // console.log(r)
